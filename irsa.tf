...
#roles for service accounts to use
...
resource "aws_iam_role" "alb_ingress" {
  name               = "${var.cluster_name}-albingress-${var.environment}"
...
data "aws_iam_policy_document" "alb_ingress" {
  statement {
    ...
    condition {
      ...
      values   = ["system:serviceaccount:${local.k8s_service_account_namespace}:${local.k8s_alb_service_account_name}"]
    }
  }
...
#need to look at making this more restrictive.
resource "aws_iam_policy" "alb_ingress_policy" {
  name        = "alb_ingress"
  description = "allow for the use of alb ingress controller"
  policy      = <<EOF
{
     "Version": "2012-10-17",
    "Statement": [
